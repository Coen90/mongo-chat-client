// 로그인 시스템 대신 임시 방편
let username = prompt("Choose your nickname.");
let roomNum = prompt("Choose chat room number.");

document.querySelector("#username").innerHTML = username;

const url = "https://port-0-mongo-chat-53px25lbt4ysr5.gksl2.cloudtype.app";
